...
class Sales extends Component {
  ...
  render() {
  	return (
      <div>
        <Subheader style={styles.header}>{this.props.title || 'Sales'}</Subheader>
        <Divider/>
        <div className="row">
          <div className="col-sm-7 c0l-xs-12">
            <Log events={this.props.events} title="Sales" filter={this.filter}/></div>
...
export default connect(mapStateToProps)(muiThemeable()(Sales));
